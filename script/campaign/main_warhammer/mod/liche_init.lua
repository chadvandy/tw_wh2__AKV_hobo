...
local function add_missions_and_unlock_requirements()
    ...
    nameless_mission:add_payload("effect_bundle{bundle_key lichemaster_lord_nameless;turns 1;}")
    ...
    draesca_mission:add_payload("effect_bundle{bundle_key lichemaster_lord_draesca;turns 1;}")
    ...
    priestess_mission:add_payload("effect_bundle{bundle_key lichemaster_lord_priestess;turns 1;}")
