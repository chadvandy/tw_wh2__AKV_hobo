...
--# assume CA_UIC.SetImagePath: method(path: string, index: number?)
...
--# assume CM.get_character_by_cqi: method(cqi: number | int) --> CA_CHAR
--# assume CM.get_region: method(regionName: string) --> CA_REGION
--# assume CM.get_faction: method(factionName: string) --> CA_FACTION
--# assume CM.get_character_by_mf_cqi: method(cqi: number | int) --> CA_CHAR
--# assume CM.char_lookup_str: method(char: number | int | CA_CHAR) --> string
--UI
...
--# assume CM.force_add_trait: method(char_lookup_str: string, trait_key: string, showMessage: boolean)
--# assume CM.force_add_trait_on_selected_character: method(trait_key: string)
--# assume CM.force_remove_trait: method(char_lookup_str: string, trait_key: string)
--# assume CM.zero_action_points: method(char_lookup_str: string)
--# assume CM.add_agent_experience: method(char_lookup_str: string, experience: number, use_level_instead_of_exp: bool?)
...
--# assume CM.stop_character_convalescing: method(cqi: number | int)
--# assume CM.award_experience_level: method(char_lookup_str: string, level: int)
--# assume CM.kill_character: method(lookup: number | int, kill_army: boolean, throughcq: boolean)
...
--# assume CM.add_building_to_force: method(militaryForce: number | int, building: string | vector<string>)
...
--# assume CM.move_character: method(char_cqi: number | int, move_x: number, move_y: number, replenish_ap: boolean?, allow_post_movement: boolean?, success_callback: function?, failure_callback: function?)
--spawning
...
--#     success_callback: (function(number | int))?
--# )
...
--# assume CM.force_attack_of_opportunity: method(attacking_mf: number | int, defending_mf: number | int, thruCq: bool)
...
--# assume CM.pending_battle_cache_char_is_defender: method(char: CA_CHAR | CA_CQI) --> boolean
--# assume CM.pending_battle_cache_char_is_attacker: method(char: CA_CHAR | CA_CQI) --> boolean
...
--rituals commands
--# assume CM.set_ritual_unlocked: method(cqi: CA_CQI | number | int, rite_key: string, unlock: boolean)
--# assume CM.set_ritual_chain_unlocked: method(cqi: CA_CQI | number | int, ritual_chain_key: string, unlock: boolean)
...
--# assume CM.pooled_resource_mod: method(cqi: CA_CQI | number | int, pooled_resource: string, factor: string, quantity: number)
...
-- CAMPAIGN UI MANAGER
--# assume CUIM.get_char_selected_cqi: method() --> (CA_CQI | number | int)
...
--CA CAMPAIGN_UI
--# assume CA_CampaignUI.TriggerCampaignScriptEvent: function(cqi: CA_CQI | number | int, event: string)
...
--# assume CA_CHAR.command_queue_index: method() --> (CA_CQI | number | int)
--# assume CA_CHAR.cqi: method() --> (CA_CQI | number | int)
...
--# assume global find_child_uicomponent: function(parent: CA_UIC, id: string) --> CA_UIC
...
--# assume global v: function(x: number|int, y: number|int, z: number|int) --> VECTOR
